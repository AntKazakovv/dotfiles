...
projects = [
    {
        ...
        "branches": ["develop", "master", "scr1-profile", "scr1-var1", "scr1-var2", "scr1-mc2", "scr1-lic1", "scr1-kiosk", "scr1-aff", "scr2-var1", "scr2-var2", "scr2-mc2", "scr2-lic1", "scr2-kiosk", "scr3-wolf1", "scr3-wolf2-mc", "scr3-wolf-aff"],
    },
    {
        # Kiosk
        "id": "2",
...
def update_language_pack(branch):
    ...
    subprocess.run(["git", "commit", "-m", f"Updated for language pack {new_tag} version"])
