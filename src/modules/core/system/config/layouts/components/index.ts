...
export * from './core/wlc-google-one-tap.config';
...
export * from './user/wlc-sign-in-page-form.config';
export * from './user/wlc-user-icon.config';
...
export * from './bonuses/wlc-bonuses-list-wolf.config';
...
export * from './history/wlc-orders-history.config';
