...
export class PreloaderLogo {
    ...
    /**
     * on bootrstrap request success remove loader from html
     */
    public async setSuccess(): Promise<void> {
    ...
    public async init(): Promise<void> {
        ...
        try {
            const baseUrl = '/static/languages/';
            ...
            let isThereTranslate = true;

            const response = await fetch(`${baseUrl}${this.lang}.json`).then(res => res.json());
            const keysPhrases = Object.keys(response);
